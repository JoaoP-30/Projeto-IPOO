...
/**
 * Representa um projétil ou ataque que se move unicamente para a esquerda.
 * Esta classe herda de {@link Ataque} e implementa sua própria lógica de movimento
 * para se deslocar horizontalmente no sentido positivo (para a esquerda).
 * @version 1.0
 */

public class AtaqueEsquerdo extends Ataque
{
    //Define a velocidade horizontal de movimento do projétil para a esquerda.
    private int velocidadeTiro = 8;
    
     /**
     * O método 'Act' é chamado a cada frame de execução.
     * Move o ataque para a esquerda usando {@code velocidadeTiro} e, em seguida,
